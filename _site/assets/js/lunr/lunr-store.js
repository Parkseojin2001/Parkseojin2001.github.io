var store = [{
        ...
        "title": "[포스팅 예시] 이곳에 제목을 입력하세요",
        "excerpt":"🦥 본문   본문은 여기에 …  ","categories": ["Machine Learning"],
        "tags": ["machine-learning"],
        "url": "/machine-learning/SL/",
        "teaser": null
      },{
        "title": "[포스팅 예시] 이곳에 제목을 입력하세요",
        ...
        "title": "비선형 자료구조",
        "excerpt":"🦥 그래프     수학에서, 좀 더 구체적으로 그래프 이론에서 그래프란 객체의 일부 쌍(pair)들이 ‘연관되어’ 있는 객체 집합 구조를 말한다.    🦥 트리   🦥 힙   🦥 트라이   ","categories": ["Data Structure"],
        "tags": ["data-structure"],
        "url": "/data-structure/nonlinear/",
        "teaser": null
      },{
        "title": "10장 케라스를 사용한 인공 신경망 소개",
        "excerpt":"지능적인 기계를 만드는 법에 대한 영감을 얻으려면 뇌 구조를 살펴보는 것이 합리적이다. 이는 인공신경망(ANN; Artificial Neural Network)을 촉발시킨 근원이다. 인공신경망은 뇌에 있는 생물학적 뉴런의 네트워크에서 영감을 받은 머신러닝 모델이다. 하지만 최근 인공 신경망은 생물학적 뉴런에서 점점 멀어지고 있으며 이러한 특징을 반영하기 위해 뉴런을 대신해 유닛(unit)이라고 부른다. 10.1 생물학적 뉴런에서 인공...","categories": ["Deep Learning"],
        "tags": ["deep-learning"],
        "url": "/deep-learning/AL/",
        "teaser": null
      }]
